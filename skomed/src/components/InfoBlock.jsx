...
export const InfoBlock = ({ infoData, children }) => {
  return (
    <View style={styles.info}>
      ...
      />
      <InfoItem title="Адрес" value={infoData.AttachmentAddress} />
      <InfoItem title="Участок" value={infoData.Territory} />
      <InfoItem title="Участковый врач" value={infoData.Doctor} />
      <InfoItem title="Статус ОСМС" value={infoData.StatusOSMS} color={infoData.StatusOSMS === "НЕ застрахован" ? THEME.DANGER_COLOR : "#1f7a1f"} />
      {children}
    </View>
  );
};
